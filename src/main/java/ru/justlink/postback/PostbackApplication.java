...
import static ru.justlink.postback.PostbackApplication.Parameter.*;
...
public class PostbackApplication {
    ...
    private void savePostbackRecord(String source, List<Object> parameterValues) {
                    ...
                    switch (parameterType) {
                        case AIM:
                            switch (parameterValue) {
                                ...
                                case "dep":
                                    return 1;
                                case "dep_without_reg":
                                    return 2;
                                default:
                                    throw new IllegalArgumentException("Unknown value for parameter <goal>");
                            }
                        default:
